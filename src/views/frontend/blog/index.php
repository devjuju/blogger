...
<section class="section-breadcrumb container-fluid p-5">
  ...
  <div class="container pb-4 mt-n1 mt-lg-0">
    <h1>Blog</h1>
    <span class="subtitle">C’est l’endroit idéal pour partager ma passion ou mes connaissances dans un secteur stimulant, 
    informant, ou simplement en amusant mes lecteurs. </span>    
  </div>
</section>
        ...
        <div class="row">
          <div class="col-lg-7  mb-lg-0">
              ...
              <div class="d-flex flex-row bd-highlight mb-3">
                  ...
                  <a href="#" class="badge fs-sm text-nav text-decoration-none">A la une</a>
                  </div>
                  <div class="badge-content bd-highlight">
              ...
              En savoir plus
               </a> <a href="#" class="btn btn-icon-secondary-round m-2">
...
<li class="list-group-item-category d-flex justify-content-between align-items-center">
<h6 class="mb-2"><a class="liste-category-blog" href="#">React</a></h6>
<span class="badge badge-counter rounded-pill">2</span>
</li>
<li class="list-group-item-category d-flex justify-content-between align-items-center">
<h6 class="mb-2"><a class="liste-category-blog" href="#">Javascript</a></h6>
<span class="badge badge-counter rounded-pill">1</span>
</li>
</ul>
