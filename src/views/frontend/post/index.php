...
<section class="section-breadcrumb container-fluid p-5">
  <nav class="container py-4 mb-lg-2" aria-label="breadcrumb">
    <ol class="breadcrumb pt-lg-3 mb-0">
      ...
      <li class="breadcrumb-item">
        <a class="breadcrumb-links" href="index.php?action=posts">Tous les articles</a>
      </li>
      <li class="breadcrumb-item">
        <a class="breadcrumb-links" href="index.php?action=posts">Catégorie</a>
      </li>
  ...
  <div class="accordion-item accordion-more-details border-0 rounded-3 mb-3">
    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
     ...
     <!-- Image on top -->
        ...
        <div class="d-flex align-items-center flex-wrap  mb-md-0 mb-4">
            <div class="fs-xs border-end pe-3 me-3 mb-2">
            <p class="mb-0 ">Catégorie: <a href="#" class="fw-semibold text-decoration-none text-color-primary">Wordpress</a></p>
            </div>
            <div class="fs-sm border-end pe-3 me-3 mb-2">
            <div class="d-flex flex-sm-row flex-column pt-2">
              <h6 class="mt-sm-1 mb-sm-2 mb-3 me-2 ">Partager avec:</h6>
              <div>
               <!-- Facebook -->
            <a href="#" class="btn btn-share-icon-secondary btn-facebook" aria-label="Facebook">
              <i class="bi bi-facebook"></i>
            </a>

            <!-- Twitter -->
            <a href="#" class="btn btn-share-icon-secondary btn-twitter" aria-label="Twitter">
              <i class="bi bi-twitter"></i>
            </a>

            <!-- Instagram -->
            <a href="#" class="btn btn-share-icon-secondary btn-instagram" aria-label="Instagram">
            ...
            <div class="fs-sm pe-3 me-3 mb-2">
            <button class="btn btn-primary" type="button">
  <i class="bi bi-pencil-square fs-lg me-2"></i>
  Editer le post
</button>
            </div>
          ...
          <div class="card card-shadow">
             ...
             <div class="card-body">
            <h5 class="card-title">Articles liés</h5>
            <ul class="list-group list-group-flush">
              <li class="list-group-item">
              <h6 class="mb-2"><a class="liste-title-blog" href="#">5 Bad Landing Page Examples &amp; How We Would Fix Them</a></h6>
    <i class="bi bi-clock fs-base me-1"></i>
    <span class="fs-sm">Sep 13, 2023</span>
    </li>
  <li class="list-group-item">
    <h6 class="mb-2"><a class="liste-title-blog" href="#">5 Bad Landing Page Examples &amp; How We Would Fix Them</a></h6>
    <i class="bi bi-clock fs-base me-1"></i>
